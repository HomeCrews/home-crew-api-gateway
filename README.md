# home-crew-api-gateway

Single entry point. Routes every public path to the service behind it.
...
|---|---|
| Port | 8080 |
| Route through the gateway | it is the gateway |
| Java package | `com.homecrew.apigateway` |
| Maven artifact | `apigateway` |
| Image | `mthanuj/homecrew-api-gateway:dev` |
...
A push to `dev` builds the image and pushes two tags to Docker Hub:
    ...
    mthanuj/homecrew-api-gateway:dev
    mthanuj/homecrew-api-gateway:sha-<short>
